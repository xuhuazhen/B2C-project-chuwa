...
import { storeCartItems } from "/src/store/cart/cartSlice";
import { updateCartThunk } from "/src/store/cart/cartThunk";
    ...
    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 24 }}>
      ...
      <div>
        ...
        <div style={{ display: "flex", gap: 12, marginTop: 12 }}>
          ...
          <Link to="/products" style={{ alignSelf: "center" }}>← Back to Products</Link>
        </div>
      </div>
    </div>
  );
